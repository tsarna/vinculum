...
func TestMcpResourcesConfig(t *testing.T) {
	...
	cfg, diags := config.NewConfig().WithSources(mcpResourcesVCL).WithLogger(logger).Build()
...
func TestMcpToolsConfig(t *testing.T) {
	...
	cfg, diags := config.NewConfig().WithSources(mcpToolsVCL).WithLogger(logger).Build()
	require.False(t, diags.HasErrors(), diags.Error())
...
func TestMcpPromptsConfig(t *testing.T) {
	...
	cfg, diags := config.NewConfig().WithSources(mcpPromptsVCL).WithLogger(logger).Build()
	require.False(t, diags.HasErrors(), diags.Error())
...
func TestMcpMountedUnderHttp(t *testing.T) {
	...
	cfg, diags := config.NewConfig().WithSources(mcpMountVCL).WithLogger(logger).Build()
	require.False(t, diags.HasErrors(), diags.Error())
