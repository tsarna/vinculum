...
| [SQL](client-sql.md) | [SQLite](client-sql.md#client-sqlite-name)[^cgo] / [Postgres](client-sql.md#client-postgres-name) | — | Run SQL via `get()`/`call()` with named queries, parameters, and result objects; MySQL forthcoming |
